---
name: hierarchy
description: Define the five-level planning hierarchy (Project → Milestone → Phase → Gate/Stream → Task); routes hierarchy-reference intent
---
# Planning Hierarchy
...
| Property | Description |
|----------|-------------|
| **Gate task ID** | `M<milestone>-<phase>.<gate>.<seq>` (e.g., `M2-4.0.1`, `M2-4.0.3`) |
| **Stream task ID** | `M<milestone>-<phase>.<stream>.<seq>` (e.g., `M2-4.A.1`, `M2-4.B.3`) |
