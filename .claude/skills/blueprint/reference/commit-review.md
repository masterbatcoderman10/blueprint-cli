---
name: commit-review
description: Manage Git during code review — worktree verification, merging to main after clean review, and conflict handling; routes commit-review and git review intent
---
# Git Review Workflow
