---
name: align
description: Bootstrap a new Blueprint project by analyzing what exists and producing foundational documents; routes alignment intent when project-progress.md is empty
---
# Alignment
