---
name: phase-complete
description: Run the phase completion verification gate after all tasks are reviewed and moved to DONE; routes phase-completion intent
---
# Phase Completion
...
<PhaseCompletionProcess>
  ...
  STEP 2 — VERIFY TRACKER STATE
    ...
    IF any tasks are in TO-DO or IN-PROGRESS:
