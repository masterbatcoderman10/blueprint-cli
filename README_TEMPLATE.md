...
**Metric placeholder:** "Used in X projects" or "Manages X+ phases" — pick one real stat for this spot.

---

## The Task Tracker

[INSERT: Screenshot of macOS app showing Kanban board with TO-DO, IN-PROGRESS, IN-REVIEW, DONE columns. Caption: "Built-in task tracker gives you visual control over phases and streams."]
...
- **v0.1.8** — Added `blueprint doctor` for automated project validation and repair.
- **v0.1.5** — Phase completion gates now surface regressions as tracked bug tasks.
...
For detailed workflows and command reference, see the [comprehensive guide →](docs/guide.md)
...
For detailed guides and command reference, see the [Getting Started](docs/getting-started.md) section in the docs.
...
- **[Getting Started](docs/getting-started.md)** — Installation, first project, tutorials
- **[Comprehensive Guide](docs/guide.md)** — Full workflows, all commands, architecture
- **[Phase Planning](docs/core/phase-planning.md)** — How to structure phases and streams
